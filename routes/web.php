...
Route::group(['middleware' => 'auth'],function( ){
        ...
        //profile
        Route::get('/profile/{post_id}/show', [ProfileController::class, 'show'])->name('profile.show');
        Route::get('/profile/edit', [ProfileController::class, 'edit'])->name('profile.edit');
         Route::patch('/profile/update', [ProfileController::class, 'update'])->name('profile.update');
         Route::get('/profile/{id}/showFollower', [ProfileController::class, 'showFollower'])->name('profile.showFollower');
         Route::get('/profile/{id}/showFollowing', [ProfileController::class, 'showFollowing'])->name('profile.showFollowing');
