        ...
        <div class="row justify-content-center">
                <div class="col-8">
                        <form action="{{ route('profile.update') }}" method="post" class="bg-white shadow rounded-3 p-5" enctype="multipart/form-data">
                                ...
                                <h2 class="h3 mb-3 fw-light text-muted">Updata Profile</h2>
                                ...
                                <div class="row mb-3">
                                        ...
                                        <div class="col-auto align-self-end">
                                                <input type="file" name="avatar" id="" class="form-control form-control sm mt-1" aria-describedby = "avatar-icon">
                                ...
                                @error('introduction')
                                        <p class="text-danger small">{{$message}}</p>
                                @enderror
                                <button tyoe="submit" class="btn btn-warning px-5">Save</button>
                        </form>
                </div>
        </div>
@endsection