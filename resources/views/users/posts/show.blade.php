                                        ...
                                        @if( $post->comments->isNotEmpty( ))
                                                <ul class="list-group mt-2">
                                                        ...
                                                        <li class="list-group-item border-0 p-0 mb-2">
                                                                <a href="{{ route('profile.show',$post->user->id) }}" class="text-decoration-none text-dark fw-bold">{{ $comment->user->id}}</a>
                                                                &nbsp;
                                                                ...
                                                                <form action="{{ route('comment.destroy', $comment->id) }}" method="post">
                                                                        ...
                                                                        {{---if the user is not the ower of the comment--}}
                                                                        @if( Auth::user( )->id === $comment->user->id)
                                                                                &middot;
                                                                                <button type="submit" class="border-0 bg-trasparent text-danger p-0 xsmall">Delete</button>
                                                                @endif
                                                                        </form>
                                                        </li>
                                                        @endforeach
